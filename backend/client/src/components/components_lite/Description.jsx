...
const Description = () => {
  ...
  return (
    ...
    //             className="cursor-pointer hover:scale-105 bg-gray-800"
    //             disabled={isApplied}
    //           >
    ...
    //         </div>
    //       </div>
    //       <h1 className="border-b-2 border-b-gray-400 font-medium my-4 py-4">
      ...
      <div>
        <div className="max-w-7xl mx-auto my-10">
          <div className="flex items-center justify-between">
            ...
            {/* Condition add kar di gayi hai: Jab user hoga tabhi ye div render hoga */}
            {user && (
              <div>
                <Button
                  onClick={isApplied ? null : applyJobHandler}
          ...
          <div className="my-4">
            ...
            {/* <h1 className="font-bold my-1">
              ...
              eius doloremque blanditiis quam.
              </span>
              </h1> */}
            <h1 className="font-bold my-1">
              Total Applicants:
